...
#FINALIZANDO E SALVANDO ROTA - TRANSPORTE

<ResumoRotaFinal2@FloatLayout>:
    orientation: "horizontal"
    canvas.before:
        Color:
            rgba: C("#1874CD")
